...
public class ToNetXML
{
    public static final String EXTENSION = ".net.xml";

    private CoordToMatrix ctm;

    public ToNetXML(CoordToMatrix ctm)
    {
        this.ctm = ctm;
    }
    ...
    public String getFormat()
    {
        ...
        text += "<net version=\"1.9\" junctionCornerDetail=\"5\" limitTurnSpeed=\"5.50\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:noNamespaceSchemaLocation=\"http://sumo.dlr.de/xsd/net_file.xsd\">\r\n\r\n"; 
        ...
        for (int i = 0; i < this.ctm.matrix.length; i++) {
            for (int j = 0; j < this.ctm.matrix[i].length; j++) {
                ...
                text += "\t<edge id=\"E" + index + "\" from=\"" + i + "\" to=\"" + j + "\" priority=\"-1\">\r\n" +
        ...
        for (int i = 0; i < this.ctm.points.length; i++) {
            ...
            text += "\t<junction id=\"" + i +"\" type=\"priority\" x=\""+ p.x() *10 +"\" y=\""+ p.y() *10 +"\" incLanes=\"\" intLanes=\"\" shape=\"142.73,46.58\"/>\r\n";
        }
